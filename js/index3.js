const questions = [
    {
        que: "1) The product of two consecutive odd integers is 143. What are the integers?",
        a: "11, 13",
        b: "13,15",
        c: "15,17",
        d: "17,19",
    ...
    {
        que: "2)The mean of five numbers is 20. If four of the numbers are 18, 22, 24, and 16, what is the fifth number?",
        a: "15",
        b: "20",
        c: "25",
        d: "30",
    ...
    {
        que: "3)If a car travels at an average speed of 60 km/h for the first half of its journey and 40 km/h for the second half, what is its average speed for the entire journey?",
        a: "45 km/h",
        b: "48 km/h",
        c: "50 km/h",
        d: " 52 km/h",
    ...
    {
        que:"4) A shopkeeper marks an item at $80, which is 25% above the cost price. What is the cost price of the item?",
        a: "$60",
        b: "$64",
        c: "$68",
        d: "$72",
    ...
    {
        que: "5) The median of a set of 7 numbers is 12. If the largest number in the set is 24, what is the smallest number?",
        a: "6",
        b: "8",
        c: "10",
        d: "12",
